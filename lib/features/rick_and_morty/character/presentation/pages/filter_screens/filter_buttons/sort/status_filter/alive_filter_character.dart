...
class AliveFilterCharacter extends StatefulWidget {
  final String data;
  const AliveFilterCharacter({super.key, required this.data});

  @override
  State<AliveFilterCharacter> createState() => _AliveFilterCharacterState();
}

class _AliveFilterCharacterState extends State<AliveFilterCharacter> {
  @override
  void initState() {
    super.initState();
