...
class MaleFilterCharacter extends StatefulWidget {
  final String data;
  const MaleFilterCharacter({super.key, required this.data});

  @override
  State<MaleFilterCharacter> createState() => _MaleFilterCharacterState();
}

class _MaleFilterCharacterState extends State<MaleFilterCharacter> {
  @override
  void initState() {
    super.initState();
