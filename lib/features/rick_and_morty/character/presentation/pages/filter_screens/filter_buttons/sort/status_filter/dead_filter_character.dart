...
class DeadFilterCharacter extends StatefulWidget {
  final String data;
  const DeadFilterCharacter({super.key, required this.data});

  @override
  State<DeadFilterCharacter> createState() => _DeadFilterCharacterState();
}

class _DeadFilterCharacterState extends State<DeadFilterCharacter> {
  @override
  void initState() {
    super.initState();
