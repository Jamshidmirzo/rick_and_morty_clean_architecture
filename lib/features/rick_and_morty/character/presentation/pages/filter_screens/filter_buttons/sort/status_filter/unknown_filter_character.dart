...
class UnknownFilterCharacter extends StatefulWidget {
  final String data;
  const UnknownFilterCharacter({super.key, required this.data});

  @override
  State<UnknownFilterCharacter> createState() => _UnknownFilterCharacterState();
}

class _UnknownFilterCharacterState extends State<UnknownFilterCharacter> {
  @override
  void initState() {
    super.initState();
    context.read<CharacterBloc>().add(
          CharacterEvent.getFilterCharacters(newUrl: 'status=${widget.data}'),
        );
  }
