...
class UnknownGenderFilterCharacter extends StatefulWidget {
  final String data;
  const UnknownGenderFilterCharacter({super.key, required this.data});

  @override
  State<UnknownGenderFilterCharacter> createState() => _UnknownGenderFilterCharacterState();
}

class _UnknownGenderFilterCharacterState extends State<UnknownGenderFilterCharacter> {
  @override
  void initState() {
    super.initState();
